...
if __name__ == "__main__":
    final_path = "checkpoints/32th_prelu_flops_lam1_sandwich_balance_2times/final_multi.pdparams"
    save_path = "checkpoints/32th_prelu_flops_lam1_sandwich_balance_2times/final.pdparams"
